...
{
    public interface IEquipmentRepository : IEquipmentRepository<DALAppDTO.Equipment>
    {
    }
    
    public interface IEquipmentRepository<TDALEntity> : IBaseRepository<TDALEntity>
